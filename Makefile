# Makefile courtesy of E. Lunderberg NSCL (2015)
...
dict: 
	@echo "Compiling ROOT dictionary $(patsubst %.o,%.cc,$@)..."
	@$(ROOTCINT) -f src/DGSEventDictionary.cc -c -p $(addprefix -I,$(INC_DIRECTORIES))  DGSEvent.h
	@mv src/DGSEventDictionary.h include/DGSEventDictionary.h
